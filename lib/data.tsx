...
export const experiencesData = [
    {
        ...
        description: [
            ...
            "Architected AI-powered tools that streamline the marketing team's gameplay-video and UGC creative production — automating repetitive editing and asset generation to cut artists' video-creation time by ~X% and scale creative output for UA campaigns.",
